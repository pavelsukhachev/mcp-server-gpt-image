...
import { IConversationStore, ConversationHistory, ConversationEntry } from '../interfaces/conversation-context.interface.js';

class MockConversationStore implements IConversationStore {
  private store = new Map<string, ConversationHistory>();
