...
export declare function generateImageResponses(input: ImageGenerationInput): Promise<ImageGenerationResult>;
export declare function editImageWithStreaming(input: ImageEditInput): AsyncGenerator<StreamingImageEvent, void, unknown>;
//# sourceMappingURL=image-generation-responses.d.ts.map