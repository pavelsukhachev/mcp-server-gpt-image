export class ResponsesImageGenerator {
    ...
    fileConverter;
    conversationContext;
    model = 'gpt-4o'; // Using gpt-4o which includes GPT-Image-1 capabilities
    constructor(responsesClient, cache, optimizer, fileConverter, conversationContext) {
        ...
        if (input.useContext && input.conversationId && this.conversationContext) {
            ...
            if (context) {
                ...
                if (lastEntry && lastEntry.metadata?.responseId) {
                    previousResponseId = lastEntry.metadata.responseId;
                }
            }
        }
        // Prepare the image generation tool configuration
...
//# sourceMappingURL=responses-image-generator.js.map