...
describe('ResponsesImageGenerator', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        generator = new ResponsesImageGenerator(mockResponsesAPIAdapter, mockCache, mockOptimizer, mockFileConverter, mockConversationContext);
    });
    describe('generate', () => {
        ...
        it('should enhance prompt with conversation context when enabled', async () => {
            ...
            expect(mockConversationContext.generateEnhancedPrompt).toHaveBeenCalledWith('Add more details', mockContext, 5);
            expect(mockResponsesAPIAdapter.create).toHaveBeenCalledWith({
                model: 'gpt-4o',
        ...
        it('should optimize images when compression is requested', async () => {
            ...
            expect(mockOptimizer.optimizeBatch).toHaveBeenCalledWith(['base64_image_data'], expect.objectContaining({ output_compression: 75 }));
        });
    });
    describe('edit', () => {
        ...
        it('should handle edit with conversation context', async () => {
            ...
            expect(mockConversationContext.generateEnhancedPrompt).toHaveBeenCalledWith('Add a lake', mockContext, undefined);
            expect(mockConversationContext.addEntry).toHaveBeenCalled();
        });
    });
...
//# sourceMappingURL=responses-image-generator.test.js.map